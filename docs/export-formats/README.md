...
All the different formats below will be supported by the web-editor. [Use the web-editor](https://nemoandrea.github.io/better-contributions/#/editor) to quickly generate a {{ $frontmatter.table_name }}.
...
```latex
% Contribution table generated by https://nemoandrea.github.io/better-contributions/editor 
% \usepackage{array} 
...
```
% Contribution table (no-package mode) generated by https://nemoandrea.github.io/better-contributions/editor 
\setlength{\arrayrulewidth}{0.7mm} 
\renewcommand{\arraystretch}{2.1} 
